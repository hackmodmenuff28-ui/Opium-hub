...
-- ============================================================
-- opium hub v5.3 FIXED3 - ALL FEATURES + KEYBINDS
-- ============================================================
...
local function getKeyName(kc)
    local n = kc.Name
    if n == "Unknown" then return "â€”" end
...
local C = {
    ...
    chipText    = Color3.fromRGB(150, 150, 150),
}
...
avatarBg.BackgroundColor3 = Color3.fromRGB(28, 28, 28)
avatarBg.BorderSizePixel = 0
avatarBg.ZIndex = 4
mkCorner(avatarBg, 26)
mkStroke(avatarBg, Color3.fromRGB(55, 55, 55), 1)
...
local function setupChar(char)
    ...
    local function startRagdollTimer()
        ...
        ragTimerActive = true
        State.countdownActive = true  -- DETECTION: Countdown started
        task.spawn(function()
            local char2 = LP.Character
            local head2 = char2 and char2:FindFirstChild("Head")
            local bb2 = head2 and head2:FindFirstChild("opiumhubBB")
            ...
            State.countdownActive = false  -- DETECTION: Countdown ended
        end)
    end
...
print("[OPIUM HUB v5.3 FIXED3] âœ… All fixes applied!")
print("âœ“ Bat Aimbot: FIXED velocity & tool finding")
print("âœ“ Infinite Jump: FIXED with direct velocity method")
print("âœ“ Auto Left/Right <-> Aimbot: FIXED mutual exclusion")
print("âœ“ TP Down: Keybind added (V)")
print("âœ“ Drop Brainrot: Keybind added (H)")
